#!/usr/bin/env python3
"""AI Assistant: every photo solved to one look comes out alike, on target.

    python3 Tools/run-ai-assistant-test.py <folder> [count] [out-dir]
"""
...
with tempfile.TemporaryDirectory() as tmp:
    binary = lrcal.build(pathlib.Path(tmp), main="test-ai-assistant.swift")
