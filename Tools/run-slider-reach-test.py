#!/usr/bin/env python3
"""Every look slider reaches further at its new end (1.5) than at its old one (1.0).

    python3 Tools/run-slider-reach-test.py <photo> [size] [out-dir]
"""
...
with tempfile.TemporaryDirectory() as tmp:
    binary = lrcal.build(pathlib.Path(tmp), main="test-slider-reach.swift")
