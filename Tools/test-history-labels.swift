...
var b = a; b.saturation = 0.15; expect(DevelopView.historyLabel(from: a, to: b), "Saturation +10")
b = a; b.exposure = 0.75; expect(DevelopView.historyLabel(from: a, to: b), "Exposure +0.50")
b = a; b.faceDehaze = 0.6; expect(DevelopView.historyLabel(from: a, to: b), "Subjects Dehaze +40")
